				...
				panels: [
					{
						...
						panelMMEvalMathStr: '',
                                                panelColor: '',
                                                panelBGColor: '',
                                                panelDynamicBGEnabled: false,
                                                panelDynamicBGMode: 'Static',
                                                panelDynamicBGBooleanZeroColor: '#00FF00',
                                                panelDynamicBGBooleanOneColor: '#FF0000',
                                                panelDynamicBGMinValue: 0,
                                                panelDynamicBGMidValue: 50,
                                                panelDynamicBGMaxValue: 100,
                                                panelDynamicBGMinColor: '#00FF00',
                                                panelDynamicBGMidColor: '#FFFF00',
                                                panelDynamicBGMaxColor: '#FF0000',
